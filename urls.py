...
#     url(r'^forms/(?P<pk>\d+)/$', 'django_json_forms.views.form', name='form'),
    url(r'^model_type/(?P<pk>\d+)/update/$', 'extensible.views.update_model_type', name='update_model_type'),
    url(r'^model_type/create/$','extensible.views.create_modeltype',name="create_modeltype"),
